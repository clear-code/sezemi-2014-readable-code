...
やること:
  ...
  * 時間が余ったら、反対の隣の人や、グループの他の人のリポジトリにも
    ...
    メンターを呼んで確認してもらう。
    （メンターとはみなさんのまわりをうろうろしているみなさんをサポート
    する人のこと。）
  * メンターが確認してOKがでたら終了！
...
やること:
  ...
  * [課題](task.md)の最初に書いている概要と進め方を説明します。
...
10分休憩。
  ...
  * CチームとPythonチームは会議室へ移動。
  * アンケートを書けるところは今後の休憩の時に随時書いていってねと連絡する。
...
やること:
  ...
  * 各自、課題を進めてください。
  * 課題は「#{自分のアカウント名}-sezemi-2014-readable-code-1」に
...
やること:
  ...
  * 時間が短いかもしれないので注意。
    * 進め方例:
      * 15:00-15:30: 各自が見つけたよいコードをそれぞれ説明→グループ内で理解
      * 15:30-16:00: グループで発表するよいコードをいくつか選んで、
        説明の仕方をまとめる。
        （発表時間は15分なので多くても3つじゃないかと思う。）

## 16:00 休憩

10分休憩。

  * 各グループのプロジェクター担当の人は接続チェックをすること。
  * アンケートを書けるところは今後の休憩の時に随時書いていってねと連絡する。
